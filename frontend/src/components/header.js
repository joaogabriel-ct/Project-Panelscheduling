...
export default function Header({ isSuperUser }) {
    ...
    return (
        <header className="flex px-4 py-2 justify-center">
            ...
            <div className="m-4">
                {isSuperUser && (
                    <button
                        className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-700 focus:outline-none"
            ...
            <div className="m-4">
                {isSuperUser && (
                    <button
                        className="px-4 py-2 bg-blue-700 text-white rounded hover:bg-blue-900 focus:outline-none"
